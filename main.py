...
# Carrega variáveis do .env se estiver em ambiente local
load_dotenv()
#AIzaSyCd8KvANF4xdZMrCynUAGlTY1cfnKeeItc
# Configura a API key do Gemini (Google)
genai.configure(api_key=os.getenv("GEMINI_API_KEY"))
print("🔐 API Key ativa:", os.getenv("GEMINI_API_KEY"))
